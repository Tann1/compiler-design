...
;
	...
	pop
;
; 026 writeln('alpha locals: a = ',a:4:2,', b = ',b:4:2,', c = ',c:4:2,', i  ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
...
;
	...
	istore_0
;
; 049 writeln('gamma parms:  i = ',i,', n = ',n,', x = ',x:4:2,', r = ',r:4: ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
...
;
; 059 writeln('main:         i = ',i,', j = ',j,', x = ',x:4:2,', y = ',y:4: ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
...
;
; 066 writeln('main:         i = ',i,', j = ',j,', x = ',x:4:2,', y = ',y:4: ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	ldc	"main:         i = %d, j = %d, x = %4.2f, y = %4.2f, p = %b\n"
	iconst_5
...
;
; 069 writeln('main:         i = ',i,', j = ',j,', x = ',x:4:2,', y = ',y:4: ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	ldc	"main:         i = %d, j = %d, x = %4.2f, y = %4.2f, p = %b\n"
	iconst_5
...
;
; 073 writeln('main:         i = ',i,', j = ',j,', x = ',x:4:2,', y = ',y:4: ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	ldc	"main:         i = %d, j = %d, x = %4.2f, y = %4.2f, p = %b\n"
	iconst_5
